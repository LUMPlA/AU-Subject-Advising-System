...
" class="nav-link page-scroll" href="subjects-management.php">Subjects</a>
                    </li>
                    <li class="nav-item">
                        <a style="  color: #333; font-family: Poppins;
" class="nav-link page-scroll" href="student-management.php">Students</a>
                    </li>
                    <li class="nav-item">
                        <a style="  color: #333; font-family: Poppins;
" class="nav-link page-scroll" href="grades-management.php">Grades</a>
                    </li>
                    <li class="nav-item">
