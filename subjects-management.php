...
?>
<html>
<title>Subjects Management - Arellano Subject Advising System - AUSAS</title>
...
<script>
    ...
    document.getElementById('btnYes').onclick = function () {
        ...
        xhr.open("POST", "delete-student.php", true);
...
<body style="background-color: #dfdfdf;">
      <section style="background: #dfdfdf; position: relative; left: 0; width: 100%; background-color: #dfdfdf; color: #333; padding: 0px 0px; box-shadow: 0 4px 5px rgba(0, 0, 0, 0.1); z-index: 1000;" class="header">
            <div class="container-fluid">
                ...
                <nav class="navbar navbar-expand-md navbar-dark">
                    <a style="color: #294D86; font-weight:bold" class="navbar-brand heading-black">AUSAS - Subjects Management</a>
                    <!-- Toggle Button -->
    ...
    height: 30px;
    align-items: center;
    color: white;'>Subject created!</p></div>
";
  ...
  echo "<div id='notification' style='visibility: visible;'><p class='notif' style='color: white; text-align: center; font-weight: 600; position: fixed;
    ...
    height: 30px;
    align-items: center;
    color: white;'>Subject deleted!</p></div>
";
        }
 ...
 echo "<div id='notification' style='visibility: visible;'><p class='notif' style='color: white; text-align: center; font-weight: 600; position: fixed;
    ...
    height: 30px;
    align-items: center;
    color: white;'>Subject updated!</p></div>
";
        }
    ...
    <form id="login-form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST">
        ...
        <input type = "submit" name = "btnsearch" value = "Search">
            ...
            <li style="text-align: right; margin-right: 45px; color: #333;"><a style="color: #333;" class="create-new-account"  href="create-subject.php"><i style="margin-right: 10px; color: #333;" class="fas fa-user-plus"></i>Create New Subject</a></li>
...
function buildtable($result){
    if(mysqli_num_rows($result) > 0){
        ...
        //create the header
        echo "<tr>";
        echo "<th>Subject Code</th><th>Description</th><th>Unit</th><th>Course</th><th>Created By</th><th>Date Created</th><th>Action</th>";
        echo "</tr>";
        echo "<br>";
        //display the data of the table
        while ($row = mysqli_fetch_array($result)){
            echo "<tr data-username='" . $row['subjectCode'] . "'>";
            ...
            echo "<a class='update' href='update-subject.php?username={$row['subjectCode']}'>Update</a>";
            echo "<a style='color: #fff;' class='delete' onclick='confirmDelete(\"{$row['subjectCode']}\")'>Delete</a>";
            echo "</td>";
            echo "</tr>";
        }
        echo "</table>";
...
if(isset($_POST['btnsearch'])){
    $sql = "SELECT * FROM tblsubject WHERE subjectCode LIKE ? OR description LIKE ? ORDER BY subjectCode";
...
<footer >
  ...
  <div id="deleteModal" class="modal">
        <div class="modal-content">
            ...
            <p style="color: #333;">Are you sure you want to delete the account with code <span id="deleteUsername"></span>?</p>
        ...
        function confirmDelete(username) {
            ...
            document.getElementById('btnYes').onclick = function () {
                ...
                xhr.setRequestHeader("Content-type", "delete-subject.php");
                xhr.onreadystatechange = function () {
