                        ...
                        if($stmt = mysqli_prepare($link, $sql_student)){
                            ...
                            if(mysqli_stmt_execute($stmt)){
                                ...
                                if(mysqli_num_rows($result_student) > 0){
                                    ...
                                    echo "<br><table>";
                                    echo "<tr>";
                                    echo "<td class= table-data id='left'>Student Number</td>";
                                    
                                    echo "<td class= table-data id='right'>" . $row_student['studentNumber'] ."</td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td class= table-data id='left'>Name</td>";
                                    
                                    echo "<td class= table-data id='right'>" . $row_student['lastName'] . ", " . $row_student['firstName'] . " " . $row_student['middleName'] ."</td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td class= table-data id='left'>Course</td>";
                                    
                                    echo "<td class= table-data id='right'>" . $row_student['course'] ."</td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td class= table-data id='left'>Year Level</td>";
                                    
                                    echo "<td class= table-data id='right'>" . $row_student['yearLevel'] ."</td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td class= table-data id = 'left'>Action</td>";
                                                    ...
                                                    if($stmt_subject = mysqli_prepare($link, $sql_subject)){
                                                        ...
                                                        if(mysqli_stmt_execute($stmt_subject)){
                                                            ...
                                                            if(mysqli_num_rows($result_subject) > 0){
                                                                ...
                                                                echo "<tr>";
                                                                echo "<td class= table-data>" . $subject_code . "</td>";
                                                                echo "<td class= table-data>" . $row_subject['description'] . "</td>";
                                                                echo "<td class= table-data>" . $row_subject['unit'] . "</td>";
                                                                echo "<td class= table-data>" . $row_grade['grade'] . "</td>";
                                                                echo "<td class= table-data>" . $row_grade['encodedBy'] . "</td>";
                                                                echo "<td class= table-data>" . $row_grade['dateCreated'] . "</td>";
                                                                 echo "<td class='action-buttons'>";
                                                                    ...
                                                                    echo "<a class='delete' onclick=\"confirmDelete('" . $subject_code . "', '" . $student_number . "')\">Delete</a>";
                                                               echo "</td>";
                                                                echo "</tr>";
